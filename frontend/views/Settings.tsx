                        ...
                        {activeTab === 'Templates' && (
                            <div className="space-y-8">
                                ...
                                <section className="white-card p-0 overflow-hidden">
                                    ...
                                    <div className="p-8 grid grid-cols-1 xl:grid-cols-[360px,1fr] gap-10">
                                        <div className="space-y-6">
                                            <div>
                                            ...
                                            <div>
                                                ...
                                                <select
                                                    ...
                                                    onChange={e => setConfig({ ...config, invoiceTemplates: { ...config.invoiceTemplates, fontFamily: e.target.value } as any })}
                                                >
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    onChange={e => setConfig({ ...config, invoiceTemplates: { ...config.invoiceTemplates, bodyFontSize: parseInt(e.target.value, 10) } as any })}
                                                />
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    onChange={e => setConfig({ ...config, invoiceTemplates: { ...config.invoiceTemplates, companyNameFontSize: parseInt(e.target.value, 10) } as any })}
                                                />
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    onChange={e => setConfig({ ...config, invoiceTemplates: { ...config.invoiceTemplates, logoWidth: parseInt(e.target.value, 10) } as any })}
                                                />
                                            </div>
                                        </div>
                                                ...
                                                <div className="space-y-8">
                                                    ...
                                                    <div className="flex justify-between items-center group/item p-6 bg-slate-50 rounded-2xl border border-slate-100">
                                                        ...
                                                        <div>
                                                            {normalizedSecuritySettings.requireTwoFactor ? (
                                                                <button 
                                                                    onClick={() => setConfig({ ...config, securitySettings: { ...normalizedSecuritySettings, requireTwoFactor: false } as any })}
